        ...
        <div className="lg:col-span-2">
          <div className="flex items-center gap-3">
            <img
              src={logoAsset}
              alt="Rádio Sinta"
              className="h-20 w-auto rounded-full drop-shadow-[0_0_20px_rgba(0,210,255,0.4)]"
              width={48}
              height={48}
            />
          </div>
          <p className="mt-5 max-w-md text-sm text-white/60">
            Rádio Sinta — A rádio online gospel focada em transmitir a presença de Deus e tocar o
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-white/70 transition-all hover:border-[#25D366]/50 hover:text-[#25D366]"
            >
