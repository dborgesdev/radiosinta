    ...
    <section id="essencia" className="relative py-32">
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-2">
          ...
          >
            <GlassCard glowColor="rgba(0, 210, 255, 0.28)" className="h-full min-h-70">
              ...
              <p className="mt-4 text-white/70">
                ...
                selecionados para criar um ambiente de adoração genuína na sua casa, trabalho ou
                veículo.
              </p>
            </GlassCard>
          </motion.div>
          ...
          >
            <GlassCard glowColor="rgba(255, 145, 0, 0.25)" className="h-full min-h-70">
              ...
              <p className="mt-4 text-white/70">
                ...
                fluida entre as canções, funcionando como um bálsamo para acalmar o seu coração nos
                momentos em que você mais precisa.
              </p>
            </GlassCard>
          </motion.div>
        </div>
